...
func NewListSeveritiesTool(c *client.Client) *ListSeveritiesTool {
	return &ListSeveritiesTool{apiClient: c}
}
...
func NewGetSeverityTool(c *client.Client) *GetSeverityTool {
	return &GetSeverityTool{apiClient: c}
}
